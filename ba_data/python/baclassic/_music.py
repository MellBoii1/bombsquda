...
ASSET_SOUNDTRACK_ENTRIES: dict[MusicType, AssetSoundtrackEntry] = {
    ...
    MusicType.MENUPIANO: AssetSoundtrackEntry('menuMusicPiano'),
    MusicType.MENU2: AssetSoundtrackEntry('menuMusic2'),
    MusicType.MENU3: AssetSoundtrackEntry('menuMusic3'),
    MusicType.MENU6: AssetSoundtrackEntry('menuMusic6'),
    MusicType.MENU7: AssetSoundtrackEntry('menuMusic7'),
    MusicType.MENU8: AssetSoundtrackEntry('menuMusic8'),
    MusicType.MENU9: AssetSoundtrackEntry('menuMusic9'),
    MusicType.MENU10: AssetSoundtrackEntry('menuMusic10'), 
    MusicType.MENU11: AssetSoundtrackEntry('menuMusic11'), # blew all the budget on menu music, didn't i? oh well, better than playing the same thing every dang time
    MusicType.MENU12: AssetSoundtrackEntry('menuMusic12'), # PAPA CERDITO VS BEBE GEORGE 🔥🔥🔥🔥🔥🔥
    MusicType.MENU67: AssetSoundtrackEntry('stupidfuckingmenu'), # i cry
    MusicType.VICTORY: AssetSoundtrackEntry(
        'victoryMusic', volume=1.2, loop=False
    ),
    MusicType.VICTORYFINAL: AssetSoundtrackEntry(
        'victoryFinal', volume=1.4, loop=False
    ),
    MusicType.CHAR_SELECT: AssetSoundtrackEntry('charSelectMusic', volume=1.0),
    MusicType.CHAR_SELECT2: AssetSoundtrackEntry('charSelect2', volume=1.0),
    ...
    MusicType.THEFINALE: AssetSoundtrackEntry('finaldestination', volume=2.1),
    MusicType.NOISESUPER: AssetSoundtrackEntry('noisexpectancy', volume=1.0),
    MusicType.SURVEY: AssetSoundtrackEntry('SURVEYPROGRAM', volume=1.0),
    MusicType.LOGOTYPE: AssetSoundtrackEntry('LOGOTYPE', volume=1.0, loop=False),
    MusicType.REPRIEVE: AssetSoundtrackEntry('johnrepri', volume=1.3),
    MusicType.WAR: AssetSoundtrackEntry('warneverends', volume=1.9),
    MusicType.RUNAROUNDFINAL: AssetSoundtrackEntry('finalrunrou', volume=1.0),
    MusicType.HURRYUP: AssetSoundtrackEntry('hurryup', volume=1.0, loop=False),
    MusicType.COOKIN: AssetSoundtrackEntry('super', volume=1.4, loop=True),
    MusicType.KEEP_AWAY: AssetSoundtrackEntry('keepAway', volume=1.0),
    MusicType.KEEP_AWAY2: AssetSoundtrackEntry('keepAway2', volume=1.0),
    MusicType.RACE: AssetSoundtrackEntry('raceMusic', volume=1.0),
    MusicType.GAMBLING: AssetSoundtrackEntry('gamblingMusic', volume=1.0),
    MusicType.CUTSCENE1: AssetSoundtrackEntry('cutscene1', volume=1.0), # the reason that this is music is that so it properly stops n everything
    MusicType.EPIC_RACE: AssetSoundtrackEntry('slowRaceMusic', volume=1.0),
    MusicType.SCORES: AssetSoundtrackEntry(
        'scoresEpicMusic', volume=1.0, loop=True
    ),
    MusicType.CREDITS: AssetSoundtrackEntry('goodfriends', loop=False),
    MusicType.BUSINESS: AssetSoundtrackEntry('porky'),
    MusicType.DEFEAT: AssetSoundtrackEntry('coopResultsMusic'),
    MusicType.GRAND_ROMP: AssetSoundtrackEntry('grandRompMusic', volume=1.5),
    MusicType.OPENING: AssetSoundtrackEntry('openingcreditsBTTDW', volume=1.0, loop=False),
    MusicType.RAGE: AssetSoundtrackEntry('megalovaniasgrandpa', volume=1.2),
    MusicType.TO_THE_DEATH: AssetSoundtrackEntry('toTheDeathMusic', volume=1.0),
    MusicType.TO_THE_DEATHFAST: AssetSoundtrackEntry('DMFMusic', volume=1.0),
    MusicType.TO_THE_DEATH2: AssetSoundtrackEntry('DM2Music', volume=1.4),
    MusicType.TO_THE_DEATH2FAST: AssetSoundtrackEntry('DMFMusic', volume=1.0),
    MusicType.TO_THE_DEATH3: AssetSoundtrackEntry('DM3Music', volume=1.0),
    MusicType.TO_THE_DEATH3FAST: AssetSoundtrackEntry('DM3FMusic', volume=1.0),
    MusicType.SNESCOURSE: AssetSoundtrackEntry('snesCourse', volume=1.0),
    MusicType.ONLINE: AssetSoundtrackEntry('acrosstheworld'),
    MusicType.PAUSE: AssetSoundtrackEntry('pausemusic'),
    MusicType.MODULATINGTIME: AssetSoundtrackEntry('O_TETR'),
    MusicType.D_RUNNIN: AssetSoundtrackEntry('d_runnin'),
    MusicType.SNESCOURSE2: AssetSoundtrackEntry('snesCourse2', volume=1.0),
    MusicType.DS1: AssetSoundtrackEntry('mkds3', volume=1.0),
    MusicType.DS2: AssetSoundtrackEntry('mkds1', volume=1.0),
    MusicType.DS3: AssetSoundtrackEntry('mkds2', volume=1.0),
    ...
    MusicType.EPICFAST: AssetSoundtrackEntry('fastEpicMusic'),
    ...
    MusicType.LAP4: AssetSoundtrackEntry('lap4'),
    MusicType.LAP5: AssetSoundtrackEntry('lap5'),
    MusicType.LAP6: AssetSoundtrackEntry('lap6'),
    MusicType.LAP7: AssetSoundtrackEntry('lap7'),
    MusicType.LAP8: AssetSoundtrackEntry('lap8'),
    MusicType.LAP9: AssetSoundtrackEntry('lap9'),
