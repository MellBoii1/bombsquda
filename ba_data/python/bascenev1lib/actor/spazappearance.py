...
def register_appearances() -> None:
    ...
    t.toes_mesh = 'none'
    t.attack_sounds = ['voicelines/rochelle/attack' + str(i + 1) + '' for i in range(3)]
    t.jump_sounds = t.attack_sounds
    t.impact_sounds = ['voicelines/rochelle/hurt' + str(i + 1) + '' for i in range(5)]
    t.death_sounds = ['voicelines/rochelle/death']
    t.pickup_sounds = t.attack_sounds
    t.fall_sounds = ['voicelines/rochelle/fall' + str(i + 1) + '' for i in range(2)]
    t.victory_sounds = ['voicelines/rochelle/win']
    t.gloat_sounds = ['voicelines/rochelle/gloat']
    t.ffire_sounds = ['voicelines/rochelle/ffire' + str(i + 1) + '' for i in range(3)]
    t.teamkill_sounds = ['voicelines/rochelle/teamkill' + str(i + 1) + '' for i in range(2)]
    t.style = 'bones'
