...
class LauncherBot(SpazBot):
    """Bomb launcher guys i guess.
...
class KNIGHTBot(SpazBot):
    ...
    throwiness = 0.3
    default_boxing_gloves_stronger = True
    run = True
    charge_dist_min = 10.0
    charge_dist_max = 9999.0
    charge_speed_min = 1.0
...
class SpazBotSet:
    ...
    def __init__(self) -> None:
        ...
        self._spawn_sound = bs.getsound('spawn2')
    ...
    def clearslowly(self) -> None:
        """Kill every bot that is alive."""
