...
class OnslaughtGame(bs.CoopGameActivity[Player, Team]):
    ...
    @override
    def _start_victory_music_loop(self):
        bs.setmusic(bs.MusicType.VICTORY1)
        self._victory_music_timer = bs.timer(15.0, self._switch_to_victory2)

    def _switch_to_victory2(self):
        bs.setmusic(bs.MusicType.VICTORY2)
        self._victory_music_timer = bs.timer(15.0, self._start_victory_music_loop)
    ...
    def _update_waves(self) -> None:
        ...
        if (
            ...
            if won:
                ...
                self._winsound.play()
                bs.cameraflash()
                self._start_victory_music_loop()
