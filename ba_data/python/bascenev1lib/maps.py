...
class SNESBattleCourse1(bs.Map):
    """A classic Kart Battle Map."""

    # noinspection PyUnresolvedReferences
    from bascenev1lib.mapdata import snes as defs

    name = 'SNES Battle Course 1'
    ...
    def get_music_type(cls) -> bs.MusicType:
        music_choices = [
            bs.MusicType.SNESCOURSE,
            bs.MusicType.SNESCOURSE2
        ]
...
class NintendoDS(bs.Map):
    """A handheld, as a course. I still don't know how to edit UVs.""" 
...
class Space(bs.Map):
    """Flying map. Flying map. Flying map."""

    # noinspection PyUnresolvedReferences
    from bascenev1lib.mapdata import space as defs
    ...
    def __init__(self) -> None:
        ...
        gnode.tint = (1.3, 1.23, 1.0)
        gnode.ambient_color = (1.1, 1.1, 1.0)
        gnode.vignette_outer = (1, 0.78, 0.85)
        gnode.vignette_inner = (0.95, 0.95, 0.93)
        gnode.vr_near_clip = 1.0
        self.is_flying = True
