...
class CoopBrowserWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        self._height = (
            ...
            else 730 if uiscale is bui.UIScale.MEDIUM else 700
        )
    ...
    def _refresh(self) -> None:
        ...
        bui.widget(
            edit=self._campaign_h_scroll,
            down_widget=self._custom_h_scroll,
        )
        ...
        sc2 = bui.containerwidget(
            parent=h_scroll,
            size=(max(self._scroll_width - 24, 30 + 200 * len(items)), 300),
            background=False,
        )
        h_spacing = 200
