...
class AllSettingsWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        width = 1000 if uiscale is bui.UIScale.SMALL else 1100
        height = 800 if uiscale is bui.UIScale.SMALL else 510
        ...
        x = width * 0.4 - all_buttons_width * 0.5
        ...
        x += bwidth + margin
        self._mel_button = _button(
            position=(x, y),
            label=bui.Lstr(resource=f'{self._r}.meloptions'),
            call=self._do_mel,
    ...
    def _do_mel(self) -> None:
        ...
        self.main_window_replace(
            MelWindow(origin_widget=self._mel_button)
        )
    ...
    def _save_state(self) -> None:
        try:
            ...
            if sel == self._controllers_button:
                ...
                sel_name = 'Back'
            elif sel == self._mel_button:
                sel_name = 'BombSquda Settings'
            else:
